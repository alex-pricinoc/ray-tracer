...
pub fn point<X: Into<F>, Y: Into<F>, Z: Into<F>>(x: X, y: Y, z: Z) -> Tuple {
    Tuple::point(x.into(), y.into(), z.into())
}

pub fn vector<X: Into<F>, Y: Into<F>, Z: Into<F>>(x: X, y: Y, z: Z) -> Tuple {
...
mod tests {
    ...
    fn point_creates_tuple_with_w_1() {
        ...
        assert_fuzzy_eq!(point.x, 4.0);
        assert_fuzzy_eq!(point.y, -4.0);
        assert_fuzzy_eq!(point.z, 3.0);
    ...
    fn vector_creates_tuple_with_w_0() {
        ...
        assert_fuzzy_eq!(vector.x, 4.0);
        assert_fuzzy_eq!(vector.y, -4.0);
        assert_fuzzy_eq!(vector.z, 3.0);
